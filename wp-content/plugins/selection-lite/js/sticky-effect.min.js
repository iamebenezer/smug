...
const mdpStickyEffect = {
    stickySectionEffect: function(e, t) {
        ...
        let n, c = 0;
        const l = () => {
            document.querySelector("." + e) || window.removeEventListener("scroll", l), s.classList.add("mdp-selection-section-sticky");
            window.scrollY >= o && document.querySelector("." + e) ? (s.classList.add("mdp-selection-section-sticky"), t.mdp_selection_sticky_effect_z_index ? s.style.zIndex = t.mdp_selection_sticky_effect_z_index : s.style.removeProperty("z-index"), s.style.top = (t.mdp_selection_sticky_section_effect_offset_top.size ? t.mdp_selection_sticky_section_effect_offset_top.size : 0) + "px", "yes" === i && (n = document.body.getBoundingClientRect().top > c ? "up" : "down", c = document.body.getBoundingClientRect().top, "up" === n ? s.classList.remove("mdp-selection-section-sticky-hide") : "down" === n && s.classList.add("mdp-selection-section-sticky-hide"))) : (s.classList.remove("mdp-selection-section-sticky"), s.classList.remove("mdp-selection-section-sticky"), s.style.removeProperty("z-index"), s.style.removeProperty("top"), s.classList.remove("mdp-selection-section-sticky-hide"))
        };
